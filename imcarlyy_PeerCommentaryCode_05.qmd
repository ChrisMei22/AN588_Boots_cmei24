...
#Comment: I like that you show each step with an easy-to-follow explanation. Also, so far your code is very neat and understandable. Great job!

Let's assume that we will bootstrap 1000 times using samples of total number of entries with replacement
...
#Comment: I was slightly confused with the part where you sample 20 rows. However, I don't think it's wrong as it is bootstrapping a sample size!
...
#Comment: I love that your code looks so clean! You're doing amazing!
...
#Comment: Christian, I love that your overall code is VERY explanatory and understandable. I didn't feel like I was struggling to understand what you were doing. I think that you did a great job, and overall, don't think you have anything else to change and consider. Amazing work!
